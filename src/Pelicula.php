<?php
    ...
    class Pelicula {
        ...
        public function mostrar(){
            $sql="SELECT peliculas.id, titulo, descripcion, foto, nombre, precio, fecha, estado FROM peliculas INNER JOIN categorías ON peliculas.categoria_id = categorías.id ORDER BY peliculas.id DESC";
