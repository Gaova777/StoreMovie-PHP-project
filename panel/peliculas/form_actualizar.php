...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="../dashboard.php">JDiego Store</a>
        </div>
    ...
    <div class="container" id="main"><!-- enctype is used to practice with files -->
        <div class="row">
            <div class="col-md-12">
            <fieldset>
                  ...
                  <input type="hidden" name="id" value="<?php print $resultado['id']?>">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <textarea class="form-control" name="descripcion" id="" cols="3" require><?php print $resultado['descripcion']?></textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="categoria_id" id="" require>
                                <option value="">--SELECCIONE--</option>
                                <?php
                                require '../../vendor/autoload.php';
                                $categoria = new Jdiego\Categoria;
